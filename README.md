[![Build status](https://ci.appveyor.com/api/projects/status/7fgjv1hr8rvn91ot?svg=true)](https://ci.appveyor.com/project/MKSInc/ahj-hw-2-dom-2-loading-and-sorting-data-attributes)
### [Gh-page](https://mksinc.github.io/AHJ-hw.-2-DOM.-2-Loading-and-Sorting.-Data-attributes/)
...
## 2.2 Loading and Sorting, data-attributes (задача со звёздочкой)
